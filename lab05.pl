...
% Please enter the name of an animal to identify its category.
% Animal name: cat
% cat is a land animal.
%
% To continue, enter another animal name or type "quit" to exit.
% Animal name: dolphin
% dolphin is a water animal.
%
% To continue, enter another animal name or type "quit" to exit.
% quit